...
public class MovieViewModel extends ViewModel {
    ...
    void setData(final Context context,String language) {
        ...
        Call<ResponseBody> result = service.dataRequest("movie",Utils.API_KEY,language);
                ...
                if(response.body() != null){
                    try {
                        ...
                        for(int x = 0 ; x < array.length() ; x++ ){
                            ...
                            dataModel.setTitle(obj.optString("title"));
                            dataModel.setScore(obj.optString("vote_average"));
                            dataModel.setDate(obj.optString("release_date"));
